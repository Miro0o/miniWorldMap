...
const STRINGS: Record<string, Record<Language, string>> = {
	...
	'tab.inspect': { en: 'Details', zh: '详情' },
	'tab.pins': { en: 'Pinned paths', zh: '固定路径' },
	'tab.view': { en: 'View', zh: '视图' },
	'tab.controls': { en: 'Display', zh: '显示' },
	'tab.defaults': { en: 'Default limits', zh: '默认限制' },
	'tab.inspect.desc': { en: 'Information and actions for the selected node or link.', zh: '查看所选节点或链接的信息与操作。' },
	'tab.pins.desc': { en: 'Keep highlighted routes visible and organize them into groups.', zh: '让高亮路线保持可见，并将其整理为分组。' },
	'tab.view.desc': { en: 'Search, fit, refresh, or change the map scope.', zh: '搜索、适配、刷新或更改地图范围。' },
	'tab.controls.desc': { en: 'Choose what the current 2D map displays and highlights.', zh: '选择当前 2D 地图显示和高亮的内容。' },
	'tab.defaults.desc': { en: 'Set the limits used when a new 2D map opens.', zh: '设置打开新 2D 地图时使用的限制。' },
	...
	'common.recenter': { en: 'Fit map', zh: '适配地图' },
	'common.fit': { en: 'Fit', zh: '适配' },
	'common.rebuild': { en: 'Refresh map', zh: '刷新地图' },
	...
	'view.search.desc': { en: 'Find a note or folder and bring it into view.', zh: '查找笔记或文件夹并将其移入视野。' },
	'view.fit.desc': { en: 'Zoom and pan until the entire current map fits on screen.', zh: '缩放和平移，使当前地图完整显示在屏幕中。' },
	'view.refresh.desc': { en: 'Rebuild the current map from the latest vault data.', zh: '根据最新的库数据重新构建当前地图。' },
	'view.atlas.desc': { en: 'Return to the normal map for the current root.', zh: '返回当前根的普通地图。' },
	'view.focus.desc': { en: 'Build a map around the selected or currently open note.', zh: '围绕所选或当前打开的笔记构建地图。' },
	'view.vaultRoot.desc': { en: 'Use the whole vault as the map root.', zh: '将整个库设为地图根节点。' },
	'view.completeMap.desc': { en: 'Show every descendant and available note link under the current root.', zh: '显示当前根下的所有后代和可用笔记链接。' },
	'view.theme.desc': { en: 'Choose the color scheme for the 2D map.', zh: '选择 2D 地图的配色方案。' },
	...
	'pins.already': { en: 'That route is already pinned.', zh: '这条路线已经固定。' },
	'pins.selectFirst': { en: 'Select at least two routes to create a group.', zh: '请至少选择两条路线来创建分组。' },
	'pins.selectBeforePin': { en: 'Select or hover a path before pinning.', zh: '先选择或悬停一条路径再固定。' },
	'pins.ungrouped': { en: 'Ungrouped', zh: '未分组' },
	'pins.allRoutes': { en: 'All pinned routes', zh: '全部固定路线' },
	'pins.selectForGroup': { en: 'Select this route for the new group', zh: '选择此路线加入新分组' },
	'pins.groupRoutes': { en: 'Group routes', zh: '路线分组' },
	'pins.groupRoutesDesc': { en: 'Enter grouping mode. A route can belong to more than one group.', zh: '进入分组模式；同一条路线可以属于多个分组。' },
	'pins.groupInstructions': { en: 'Select at least two routes below. Existing group memberships are kept.', zh: '请在下方至少选择两条路线；已有的分组归属会被保留。' },
	'pins.selectedCount': { en: '{count} selected', zh: '已选择 {count} 条' },
	'pins.createGroup': { en: 'Create group', zh: '创建分组' },
	'pins.cancelGrouping': { en: 'Cancel', zh: '取消' },
	'pins.clearAll': { en: 'Clear all', zh: '全部清除' },
	'pins.clearAllDesc': { en: 'Remove every pinned route and route group.', zh: '移除所有固定路线和路线分组。' },
	'pins.pinCurrentDesc': { en: 'Pin the currently selected or hovered route.', zh: '固定当前选中或悬停的路线。' },
	'pins.remove': { en: 'Remove pin', zh: '移除固定' },
	'pins.removeDesc': { en: 'Remove this pinned route from the map and every group.', zh: '从地图和所有分组中移除此固定路线。' },
	'pins.removeFromGroup': { en: 'Remove from group', zh: '移出分组' },
	'pins.removeFromGroupDesc': { en: 'Remove this route only from this group.', zh: '仅将这条路线移出当前分组。' },
	'pins.hideGroup': { en: 'Hide group', zh: '隐藏分组' },
	'pins.hideGroupDesc': { en: 'Hide this group’s routes. Shared routes remain visible through other shown groups.', zh: '隐藏此分组的路线；共享路线仍可通过其他显示中的分组保持可见。' },
	'pins.showGroup': { en: 'Show group', zh: '显示分组' },
	'pins.showGroupDesc': { en: 'Show this group’s individually enabled routes.', zh: '显示此分组中单独启用的路线。' },
	'pins.dissolveGroup': { en: 'Dissolve group', zh: '解散分组' },
	'pins.dissolveGroupDesc': { en: 'Keep the routes but remove this group.', zh: '保留路线，但移除此分组。' },
	'pins.hideHighlight': { en: 'Hide route', zh: '隐藏路线' },
	'pins.showHighlight': { en: 'Show route', zh: '显示路线' },

	'control.depth': { en: 'Levels shown', zh: '显示层级数' },
	'control.nodes': { en: 'Node limit', zh: '节点上限' },
	...
	'control.ringGuides': { en: 'Show depth rings', zh: '显示层级环' },
	'control.outsideLinks': { en: 'Cross-root links', zh: '跨根链接' },
	'control.outsideDetail': { en: 'Cross-root detail', zh: '跨根细节' },
	'control.exactOutsideFiles': { en: 'Outside-note limit', zh: '外部笔记上限' },
	'control.legend': { en: 'Legend', zh: '图例' },
	'control.defaultDepth': { en: 'Default levels', zh: '默认层级数' },
	'control.defaultNodes': { en: 'Default node limit', zh: '默认节点上限' },
	'control.defaultNoteLinks': { en: 'Default link limit', zh: '默认链接上限' },
	'control.unresolvedLinks': { en: 'Include missing-note links', zh: '包含缺失笔记链接' },
	...
	'labels.auto': { en: 'Automatic', zh: '自动显示' },
	'labels.hover': { en: 'Hovered paths only', zh: '仅悬停路径' },
	'outside.grouped': { en: 'Group by branch', zh: '按分支分组' },
	'outside.selected': { en: 'Exact for selected', zh: '所选项精确显示' },
	'outside.exact': { en: 'Exact notes', zh: '精确笔记' },
	...
	'settings.outsideDetailDesc': { en: 'Choose whether outside notes are grouped by branch or shown individually.', zh: '选择将外部笔记按分支分组还是逐个显示。' },
	'settings.outsideLimitDesc': { en: 'Maximum number of individual notes shown outside the current root.', zh: '当前根之外最多显示的独立笔记数。' },
	'settings.legendDesc': { en: 'Toggle map element types. Hover an item to see what it represents.', zh: '开关不同地图元素；悬停项目可查看其含义。' },
